...
def plot_metric_for_all_algos(results, metric):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"./figures/{metric}.png", format="png")


def export_to_csv(results, filename="benchmark.csv"):
    """
    results : liste de tuples (size, {algo: {metric: [values]}})
    """
